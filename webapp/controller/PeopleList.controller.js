sap.ui.define([
	...
	return Controller.extend("zzz.controller.PeopleList", {
		...
		onInputChange : function (oEvt) {
			if (oEvt.getParameter("escPressed")) {
				...
				if (oEvt.getSource().getParent().getBindingContext("people").getProperty("UserName")) {
		...
		onResetDataSource : function () {
			var oModel = this.getView().getModel("people"),
		...
		onDelete : function () {
			...
			if (oSelected) {
				oSelected.getBindingContext("people").delete("$auto").then(function () {
		...
		onSave : function () {
			...
			this.getView().getModel("people").submitBatch("peopleGroup").then(fnSuccess, fnError);
